...
Various case studies with ordinal and/or continuous endpoints are analyzed in 
this repo using the information-theoretic causal inference (ITCI) framework.
